...
function generateCV() {
  ...
  document.getElementById("fFacebook").href = document.getElementById("fbField").value;
  document.getElementById("lLinkedin").href = document.getElementById("linkedField").value;
